...

{
  ...
  let url = `https://docs.google.com/spreadsheets/d/${sheetId}/gviz/tq?tqx=out:json&sheet=${
    ...
    .then((response) => {
      ...
      fetch("./contents/debit-credit.html?t=" + new Date().getTime())
        ...
        .then((response) => {
          ...
          document.querySelector(".form-inputDiv").style.display = "none";
          document.querySelector(".form-input0").disabled = true;
